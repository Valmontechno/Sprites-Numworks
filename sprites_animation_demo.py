...
textColor = '#000000'
pallets = [
    ('#d82800','#887000','#fc9838',gbColor),
    ('#fcd8a8','#d82800','#fc9838',gbColor)
]
...
fillScreen(gbColor)
draw_string('Sprites animation demo', 10, 5, textColor, gbColor)
draw_string('Press OK', 10, 25, textColor, gbColor)
